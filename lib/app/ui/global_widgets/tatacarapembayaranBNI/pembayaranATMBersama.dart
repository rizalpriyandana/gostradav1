...
class PembayaranAtmBersama extends StatelessWidget {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.only(left: 0.sp),
          child: Text(
            '5. Masukkan nomor rekening tujuan dengan 16 digit \n\t\t\t\tNomor VA (Contoh: 8241002201150001)',
            style: TextStyle(fontSize: 10.sp, color: DataColors.primary600),
            textAlign: TextAlign.justify,
          ),
        ),
        ...
        Padding(
          padding: EdgeInsets.only(left: 0.sp),
          child: Text(
            '6.\tMasukkan nominal trasfer sesuai tagihan atau \n\t\t\t kewajiban Anda. Nominal yang berbeda tidak \n\t\t\t dapat diproses',
            style: TextStyle(fontSize: 10.sp, color: DataColors.primary600),
            textAlign: TextAlign.justify,
          ),
        ),
        ...
        Padding(
          padding: EdgeInsets.only(left: 0.sp),
          child: Text(
            '7.\tKonfirmasi rincian Anda akan tampil di layar, cek \n\t\t\t\tdan tekan "Ya" untuk melanjutkan',
            style: TextStyle(fontSize: 10.sp, color: DataColors.primary600),
            textAlign: TextAlign.justify,
          ),
        ),
