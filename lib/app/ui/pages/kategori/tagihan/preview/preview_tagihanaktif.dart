...
class PreviewTagihanAktifPage extends StatefulWidget {
  @override
  State<PreviewTagihanAktifPage> createState() =>
      _PreviewTagihanAktifPageState();
}

class _PreviewTagihanAktifPageState extends State<PreviewTagihanAktifPage> {
  @override
